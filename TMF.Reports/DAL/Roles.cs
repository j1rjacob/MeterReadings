...
{
    public class Roles : BaseDAL
    {
        public Roles()
        {
            SQL_DELETE = "[REPORT USERROLES_DEL]";
            SQL_GET = "[REPORT USERROLES_GET]";
            SQL_GET_LIST = "[REPORT USERROLES_LST]";
            SQL_INSERT = "[REPORT USERROLES_INS]";
            SQL_UPDATE = "[REPORT USERROLES_UPD]";
            PARM_ID = "@Id";
        }
        ...
        {
            string cmdText = "[REPORT USERROLES_LST_BYDESCRIPTION]";
            SqlParameter[] array = new SqlParameter[]
            {
