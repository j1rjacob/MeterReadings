...
{
    public class GatewayLog : BaseDAL
    {
        public GatewayLog()
        {
            SQL_DELETE = "[REPORT GATEWAYLOG_DEL]";
            SQL_GET = "[REPORT GATEWAYLOG_GET]";
            SQL_GET_LIST = "[REPORT GATEWAYLOG_LST]";
            SQL_INSERT = "[REPORT GATEWAYLOG_INS]";
            SQL_UPDATE = "[REPORT GATEWAYLOG_UPD]";
            PARM_ID = "@Id";
        }
        ...
        public override IInfo GetRecord(SmartDB dbInstance, object Id)
        {
            ...
            array[0].Value = Id;
            Model.GatewayLog bizObject = null;
            IInfo result;
            try
            {
        ...
        {
            var list = new List<Model.GatewayLog>();
            IInfo result;
            try
            {
                bool transactionControl = dbInstance.TransactionControl;
        ...
        {
            string cmdText = "[REPORT GATEWAYLOG_LST_BYDESCRIPTION]";
            SqlParameter[] array = new SqlParameter[]
            {
