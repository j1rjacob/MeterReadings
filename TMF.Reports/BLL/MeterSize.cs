...
namespace TMF.Reports.BLL
{
    ...
    {
        private static readonly DAL.MeterSize _dal = new DAL.MeterSize();
        ...
        public ReturnInfo IsValid(Model.MeterSize info)
        {
        ...
        public ReturnInfo Create(SmartDB dbInstance, ref Model.MeterSize info)
        {
        ...
        public ReturnInfo Update(SmartDB dbInstance, Model.MeterSize info)
        {
            ...
            if (flag)
            {
                bool flag2 = (info2.BizObject as Model.MeterSize).LockCount == info.LockCount;
                if (!flag2)
                {
        ...
        public ReturnInfo GetMeterSizeById(SmartDB dbInstance, string Id)
        {
        ...
        public ReturnInfo GetMeterSizeByDescription(SmartDB dbInstance, string Description)
        {
        ...
        public ReturnInfo GetMeterSizeList(SmartDB dbInstance)
        {
            ...
            return new ReturnInfo
            {
                ...
                BizObject = ((records.Code == ErrorEnum.NoError) ? records.BizObject : new List<Model.MeterSize>())
            };
        }
    }
}
