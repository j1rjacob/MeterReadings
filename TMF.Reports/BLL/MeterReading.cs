...
{
    public class MeterReading : BusinessBase
    {
        private static readonly DAL.MeterReading _dal = new DAL.MeterReading();
        ...
        public ReturnInfo GetMeterReadingById(SmartDB dbInstance, string Id)
        {
        ...
        public ReturnInfo GetMeterReadingList(SmartDB dbInstance)
        {
            ...
            return new ReturnInfo
            {
                ...
                BizObject = ((records.Code == ErrorEnum.NoError) ? records.BizObject : new List<Model.MeterReading>())
            };
        }
    }
}
